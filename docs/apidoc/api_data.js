define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "group_id",
            "description": "<p>(optional) Group ID where you want to share this process with</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  {
    "type": "get",
    "url": "/resource/ls/:resource_id/:instance_id?",
    ...
    "filename": "api/controllers/resource.js",
    "groupTitle": "Resource",
    "name": "GetResourceLsResource_idInstance_id"
  },
  {
    "group": "Resource",
    "type": "get",
  ...
  },
  {
    ...
    "title": "Upload File",
    "description": "<p>Upload a file to specified resource on a specified path (needs to be inside a workdir)</p>",
    "header": {
      "fields": {
        "Header": [
          {
